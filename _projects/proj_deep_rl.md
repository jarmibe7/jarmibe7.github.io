...
## Introduction
#### Objective
The goal of this project was to learn pathfinding with reinforcement learning (RL). While A* is a widely used path planning algorithm in robotics, RL and other learning-based approaches can be model-free, more adaptive, and allow more optimization design choices.
